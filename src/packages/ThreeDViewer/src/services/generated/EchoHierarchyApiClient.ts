...
export class DataMaintenanceClient implements IDataMaintenanceClient {
     ...
     * @return Success
     */
    triggerMaintenanceOfHierarchyCollection(body?: string | undefined, signal?: AbortSignal | undefined): Promise<void> {
...
export interface IHierarchyClient {
     ...
     * @return Success
     */
    findNodesByTagContains(collection: string, limit?: number | undefined, body?: string | undefined): Promise<HierarchyNodeModelListResult>;
    /**
     * @param limit (optional) 
     * @param body (optional) 
     * @return Success
     */
    findNodesByNameStartsWith(collection: string, limit?: number | undefined, body?: string | undefined): Promise<HierarchyNodeModelListResult>;
    /**
     * @param limit (optional) 
     * @param body (optional) 
     * @return Success
     */
    findNodesByNameContains(collection: string, limit?: number | undefined, body?: string | undefined): Promise<HierarchyNodeModelListResult>;
    /**
     ...
     * @return Success
     */
    listNodesMatchingPdmsKeyValuePair(collection: string, pdmsKey?: string | undefined, pdmsValue?: string | undefined): Promise<HierarchyNodeModel[]>;
    /**
     * @param pdmsKey (optional) 
     * @param pdmsValue (optional) 
     * @return Success
     */
    listNodeIdsMatchingPdmsKeyValuePair(collection: string, pdmsKey?: string | undefined, pdmsValue?: string | undefined): Promise<number[]>;
}
...
export class HierarchyClient implements IHierarchyClient {
     ...
     * @return Success
     */
    findLeafNodeIdsByTopNodeId(collection: string, topNodeId: number, signal?: AbortSignal | undefined): Promise<UInt32ListResult> {
     ...
     * @return Success
     */
    findLeafNodeIdsByTopNodeIdsBatch(collection: string, body?: number[] | undefined, signal?: AbortSignal | undefined): Promise<UInt32ListResult> {
     ...
     * @return Success
     */
    getNodesByName(collection: string, body?: string | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    listLeafNodeIdsByProjectNo(collection: string, projectNo: string, signal?: AbortSignal | undefined): Promise<number[]> {
     ...
     * @return Success
     */
    getNodeByPath(collection: string, body?: string[] | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModel> {
     ...
     * @return Success
     */
    findNodesByTagContains(collection: string, limit?: number | undefined, body?: string | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    findNodesByNameStartsWith(collection: string, limit?: number | undefined, body?: string | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    findNodesByNameContains(collection: string, limit?: number | undefined, body?: string | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    findNodesByNodeIds(collection: string, body?: number[] | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    findNodesByTagList(collection: string, body?: string[] | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    findLeafNodesByTagList(collection: string, body?: string[] | undefined, signal?: AbortSignal | undefined): Promise<NodeWithLeafNodesListResult> {
     ...
     * @return Success
     */
    findLeafNodesByTag(collection: string, body?: string | undefined, signal?: AbortSignal | undefined): Promise<UInt32ListResult> {
     ...
     * @return Success
     */
    findExistingTagsByTags(collection: string, body?: string[] | undefined, signal?: AbortSignal | undefined): Promise<string[]> {
     ...
     * @return Success
     */
    listTagsInSystem(collection: string, systemCode: string, limit?: number | undefined, signal?: AbortSignal | undefined): Promise<StringListResult> {
     ...
     * @return Success
     */
    getNodesBySystem(collection: string, systemCode: string, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    getLeafNodesBySystem(collection: string, systemCode: string, signal?: AbortSignal | undefined): Promise<HierarchyNodeModelListResult> {
     ...
     * @return Success
     */
    getLeafNodeIdsBySystem(collection: string, systemCode: string, signal?: AbortSignal | undefined): Promise<UInt32ListResult> {
     ...
     * @return Success
     */
    getNodesByRefNo(collection: string, refNo?: string[] | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModel[]> {
        ...
        if (refNo === null)
            ...
            refNo && refNo.forEach(item => { url_ += "refNo=" + encodeURIComponent("" + item) + "&"; });
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetNodesByRefNo(response: Response): Promise<HierarchyNodeModel[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(HierarchyNodeModel.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    findNodesByRefNoBatch(collection: string, body?: string[] | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModel[]> {
        let url_ = this.baseUrl + "/api/v2/hierarchy/{collection}/node/refNo";
        if (collection === undefined || collection === null)
            throw new Error("The parameter 'collection' must be defined.");
        url_ = url_.replace("{collection}", encodeURIComponent("" + collection));
     ...
     * @return Success
     */
    getNodeIdsByRefNos(collection: string, refNo?: string[] | undefined, signal?: AbortSignal | undefined): Promise<number[]> {
     ...
     * @return Success
     */
    getNodeIdsByRefNosBatch(collection: string, body?: string[] | undefined, signal?: AbortSignal | undefined): Promise<number[]> {
        let url_ = this.baseUrl + "/api/v2/hierarchy/{collection}/node/refNo/ids";
        if (collection === undefined || collection === null)
            throw new Error("The parameter 'collection' must be defined.");
        url_ = url_.replace("{collection}", encodeURIComponent("" + collection));
     ...
     * @return Success
     */
    listPdmsValuesByPdmsKey(collection: string, pdmsKey?: string | undefined, signal?: AbortSignal | undefined): Promise<string[]> {
        let url_ = this.baseUrl + "/api/v2/hierarchy/{collection}/pdms/values?";
        if (collection === undefined || collection === null)
            throw new Error("The parameter 'collection' must be defined.");
        url_ = url_.replace("{collection}", encodeURIComponent("" + collection));
        if (pdmsKey === null)
            throw new Error("The parameter 'pdmsKey' cannot be null.");
        else if (pdmsKey !== undefined)
            url_ += "pdmsKey=" + encodeURIComponent("" + pdmsKey) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    listNodesMatchingPdmsKeyValuePair(collection: string, pdmsKey?: string | undefined, pdmsValue?: string | undefined, signal?: AbortSignal | undefined): Promise<HierarchyNodeModel[]> {
        ...
        if (pdmsKey === null)
            ...
            url_ += "pdmsKey=" + encodeURIComponent("" + pdmsKey) + "&";
        if (pdmsValue === null)
            throw new Error("The parameter 'pdmsValue' cannot be null.");
        else if (pdmsValue !== undefined)
            url_ += "pdmsValue=" + encodeURIComponent("" + pdmsValue) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    listNodeIdsMatchingPdmsKeyValuePair(collection: string, pdmsKey?: string | undefined, pdmsValue?: string | undefined, signal?: AbortSignal | undefined): Promise<number[]> {
...
export class HierarchyNodeModel implements IHierarchyNodeModel {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["fullPath"])) {
                ...
                for (let item of _data["fullPath"])
            ...
            if (_data["pdmsData"]) {
                ...
                for (let key in _data["pdmsData"]) {
                    if (_data["pdmsData"].hasOwnProperty(key))
                        (<any>this.pdmsData)![key] = _data["pdmsData"][key];
                }
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.fullPath)) {
            data["fullPath"] = [];
            for (let item of this.fullPath)
                data["fullPath"].push(item);
        }
        data["tag"] = this.tag;
        ...
        if (this.pdmsData) {
            ...
            for (let key in this.pdmsData) {
                if (this.pdmsData.hasOwnProperty(key))
                    (<any>data["pdmsData"])[key] = this.pdmsData[key];
            }
        }
        ...
        if (_data) {
            if (Array.isArray(_data["results"])) {
                ...
                for (let item of _data["results"])
                    this.results!.push(HierarchyNodeModel.fromJS(item));
            }
...
export class NodeWithLeafNodes implements INodeWithLeafNodes {
    ...
    init(_data?: any) {
        if (_data) {
            this.parentNode = _data["parentNode"] ? SimpleNodeModel.fromJS(_data["parentNode"]) : <any>undefined;
            if (Array.isArray(_data["leafNodes"])) {
                this.leafNodes = [] as any;
                for (let item of _data["leafNodes"])
                    this.leafNodes!.push(SimpleNodeModel.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.leafNodes)) {
            data["leafNodes"] = [];
            for (let item of this.leafNodes)
                data["leafNodes"].push(item.toJSON());
        }
        return data; 
    }
}
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(NodeWithLeafNodes.fromJS(item));
            }
            this.totalResults = _data["totalResults"];
        }
    }
