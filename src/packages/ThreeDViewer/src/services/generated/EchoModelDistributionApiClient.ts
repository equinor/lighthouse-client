...
export class ModelAdminClient implements IModelAdminClient {
     ...
     * @return Success
     */
    updateModelUploadCompleted(uploadTokenId: string, state: ModelStates, signal?: AbortSignal | undefined): Promise<void> {
...
export interface IModelsClient {
     ...
     * @return Success
     */
    listModels(artifactKind?: string | null | undefined, artifactVersion?: string | null | undefined, plantCode?: string | null | undefined, plantSection?: string | null | undefined): Promise<AssetMetadataSimpleDto[]>;
    /**
     * Get a model by Id
     * @return Success
     */
...
export class ModelsClient implements IModelsClient {
     ...
     * @return Success
     */
    listModels(artifactKind?: string | null | undefined, artifactVersion?: string | null | undefined, plantCode?: string | null | undefined, plantSection?: string | null | undefined, signal?: AbortSignal | undefined): Promise<AssetMetadataSimpleDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(AssetMetadataSimpleDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export interface IRevealProxyClient {
     ...
     * @return Success
     */
    getRevealRevisionOutputs(projectId: string | null, modelId: number, revisionId: number, format?: string | null | undefined): Promise<RevealRevisionOutputs>;
    /**
     * @return Success
     */
...
export class RevealProxyClient implements IRevealProxyClient {
     ...
     * @return Success
     */
    getRevealRevision3d(projectId: string | null, modelId: number, revisionId: number, signal?: AbortSignal | undefined): Promise<RevealRevision3D> {
     ...
     * @return Success
     */
    getRevealRevisionOutputs(projectId: string | null, modelId: number, revisionId: number, format?: string | null | undefined, signal?: AbortSignal | undefined): Promise<RevealRevisionOutputs> {
     ...
     * @return Success
     */
    getFilesByProjectIdAndModelId(projectId: string | null, modelId: number, fileName: string | null, signal?: AbortSignal | undefined): Promise<Stream> {
...
export class AssetMetadataDto implements IAssetMetadataDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.buildRunDateTimeIso8601 = _data["buildRunDateTimeIso8601"] ? new Date(_data["buildRunDateTimeIso8601"].toString()) : <any>undefined;
            this.sourceModelUpdatedDateTimeIso8601 = _data["sourceModelUpdatedDateTimeIso8601"] ? new Date(_data["sourceModelUpdatedDateTimeIso8601"].toString()) : <any>undefined;
            if (_data["metadata"]) {
    ...
    toJSON(data?: any) {
        ...
        data["buildRunDateTimeIso8601"] = this.buildRunDateTimeIso8601 ? this.buildRunDateTimeIso8601.toISOString() : <any>undefined;
        data["sourceModelUpdatedDateTimeIso8601"] = this.sourceModelUpdatedDateTimeIso8601 ? this.sourceModelUpdatedDateTimeIso8601.toISOString() : <any>undefined;
        if (this.metadata) {
            data["metadata"] = {};
...
export class AssetMetadataSimpleDto implements IAssetMetadataSimpleDto {
    ...
    filesPrefix?: string | undefined;
    projectNameLabel?: string | undefined;
    platformNameLabel?: string | undefined;
    projectSectionId?: string | undefined;
    platformSectionId?: string | undefined;
    platformSectionLabel?: string | undefined;
...
export class AssetDownloadDto implements IAssetDownloadDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.assetMetaData = _data["assetMetaData"] ? AssetMetadataDto.fromJS(_data["assetMetaData"]) : <any>undefined;
            this.assetDownloadInfo = _data["assetDownloadInfo"] ? AssetDownloadToken.fromJS(_data["assetDownloadInfo"]) : <any>undefined;
...
export class RevealRevision3D implements IRevealRevision3D {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["rotation"])) {
                ...
                for (let item of _data["rotation"])
                    this.rotation!.push(item);
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.rotation)) {
            data["rotation"] = [];
            for (let item of this.rotation)
                data["rotation"].push(item);
        }
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    (<any>this).items!.push(RevealBlobOutputMetadata.fromJS(item));
            }
        }
    }
