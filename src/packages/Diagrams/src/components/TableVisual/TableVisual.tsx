...
import { FooterRow, TableCell, TableHeadCell, TableRow, TableWrapper, TypeChip, TypeWrapper } from './Styles/Table';
...
export function TableVisual<T>({ data, options }: TableVisualProps<T>) {
