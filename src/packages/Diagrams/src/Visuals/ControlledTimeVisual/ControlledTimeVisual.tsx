...
export type ControlledTimeBarChartProps<T extends Record<PropertyKey, unknown>> = {
    data: T[];
    options: ControlledTimeBarChartOptions<T>;
};
export type ControlledTimeBarChartOptions<T extends Record<PropertyKey, unknown>> = {
