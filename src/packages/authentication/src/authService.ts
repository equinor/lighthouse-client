...
export interface AuthenticationProvider {
    ...
    acquireAccessToken(options?: { scopes?: string[] }): Promise<string>;
    getUserName: () => string;
}
...
export function authenticationProvider(
    ...
    async function acquireAccessToken(option: { scopes?: string[] }): Promise<string> {
        return getAccessToken(option?.scopes);
    }
