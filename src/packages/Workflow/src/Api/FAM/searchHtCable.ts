...
export async function searchHtCable(value: string): Promise<FamTag[]> {
  ...
  const res = await FAM.fetch('v1/typed/completion/custom_scope_tag/facility/JCA?view-version=v1', {
