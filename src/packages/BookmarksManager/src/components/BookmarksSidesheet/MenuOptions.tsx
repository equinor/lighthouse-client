...
export const MenuOptions = ({ bookmark }: MenuOptionsProps) => {
  ...
  return (
    <>
      <IconMenu
        items={
          currentUser?.id === bookmark.createdBy.azureUniqueId ? ownerOptions : nonOwnerOptions
        }
        placement="bottom"
      />
      <Switch defaultCase={<></>}>
        <Case when={openedModal === 'Edit'}>
          <Modal
            title={'Edit bookmark'}
            content={
              <EditModalContent bookmark={bookmark} closeModal={() => setOpenedModal(null)} />
            }
          />
        </Case>
        <Case when={openedModal === 'Delete'}>
          <Modal
            ...
            content={
              <DeleteModalContent bookmark={bookmark} closeModal={() => setOpenedModal(null)} />
            }
          />
        </Case>
        <Case when={openedModal === 'Share'}>
          <Modal
            ...
            content={
              <ShareModalContent bookmark={bookmark} closeModal={() => setOpenedModal(null)} />
            }
          />
        </Case>
        ...
        <Case when={openedModal === 'Unshare'}>
          <Modal
            ...
            content={
              <UnshareModalContent bookmark={bookmark} closeModal={() => setOpenedModal(null)} />
            }
          />
        </Case>
      </Switch>
