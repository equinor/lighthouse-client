        ...
        <CircuitAndStarterWrapper>
          ...
          {isEditMode && !disconnected && (
            <div>
              ...
              {isOpen && (
                <CircuitDiagramPopover>{'Connected. Click to isolate'}</CircuitDiagramPopover>
              )}
            </div>
          )}
          {isEditMode && disconnected && (
            <div>
              ...
              >
                <Icon name={'lock'} color={tokens.colors.ui.background__light.hex} size={16} />
                Deisolate
              </DeisolateButton>
              {isOpen && (
                <CircuitDiagramPopover>
                  {
                    <DisconnectedPopover>
                      <div>
                        Isolated by{' '}
                        {eleNetwork?.isolatedBy?.firstName + ' ' + eleNetwork?.isolatedBy?.lastName}{' '}
