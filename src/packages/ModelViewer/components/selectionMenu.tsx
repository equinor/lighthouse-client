    ...
    <WrapperMenu>
      <Menu>
        ...
        >
          <Icon
            name={'crop'}
            color={isCropped ? tokens.colors.text.static_icons__secondary.rgba : undefined}
          />
        </Button>
        <Button
          variant="ghost_icon"
        ...
        >
          <Icon
            name={'visibility'}
            color={modelIsVisible ? tokens.colors.text.static_icons__secondary.rgba : undefined}
          />
        </Button>
        ...
        >
          <Icon
            name={'color_palette'}
            color={hasDefaultColor ? undefined : tokens.colors.text.static_icons__secondary.rgba}
          />
        </Button>
        <Button
        ...
        >
          <Icon name={'fullscreen'} color={tokens.colors.text.static_icons__secondary.rgba} />
        </Button>
      </Menu>
    </WrapperMenu>
  );
