          ...
          >
            {isSubGroup(item) ? (
              CustomSubGroup ? (
                ...
                <SubGroup onClick={() => handleExpand(item)} style={{ width: `${width}%` }}>
                  <SubGroupText>
              ...
              <PackageChild
                ...
                columnExpanded={
                  expand?.expandedColumns?.[garden[virtualColumn.index].value]?.isExpanded ?? false
                }
              ...
              <DefaultGardenItem
                ...
                customDescription={customDescription && customDescription(item.item)}
              />
            )}
          </PackageRoot>
        );
