...
export interface GardenOptions<T extends Record<PropertyKey, unknown>, D = T> {
    gardenKey: keyof T;
    itemKey: keyof T;
...
export interface GardenDataIntercepters<T extends Record<PropertyKey, unknown>> {
