...
const LogoIcon = ({ width = 50, height = 35 }): JSX.Element => {
    return (
        <svg width={width} height={height} viewBox="0 0 50 35" fill="none" style={{ transform: "scale(0.7)" }}>
            ...
            <path d="M7.05434 7.05434L0 0L1.21096 13.8183L7.68846 14.3818L7.05434 7.05434Z" transform="translate(33.8887 34.9863) scale(0.92727 -1.06779) rotate(45)" fill="#990025">
                ...
                <stop offset="0.508287" stopColor="#DC002E"></stop><stop offset="0.508387" stopColor="#FF1243"></stop></linearGradient><linearGradient id="paint1_linear" x2="1" gradientUnits="userSpaceOnUse" gradientTransform="matrix(-13.5478 9.01983 -12.9578 -13.5478 18.0677 6.77391)"><stop offset="0.508287" stop-color="#DC002E"></stop><stop offset="0.508387" stopColor="#FF1243"></stop>
