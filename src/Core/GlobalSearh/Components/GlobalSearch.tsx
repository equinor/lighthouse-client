        ...
        {searchInput.length > 0 && search.length > 0 && (
          <SearchResult>
            {searchResult.length > 0 ? (
              <>
                {searchResult.map((searchType) => (
                  <div key={searchType.type}>
                    <SearchResultHeading typeTitle={searchType.title} color={searchType.color} />
                        ...
                        <SearchResultItem
                          ...
                          appAction={
                            searchType.appAction
                              ? (id: string) => {
                                  searchType.appAction && searchType.appAction(id, navigate);
                                  setSearchInput('');
                                }
                              : undefined
                          }
              ...
              !isSearching && <NoResult>Sorry, Could not find what you are looking for.</NoResult>
            )}
          </SearchResult>
        )}
      </ArrowNavigation>
