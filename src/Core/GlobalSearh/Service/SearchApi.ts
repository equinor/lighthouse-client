...
export class Search {
  ...
  private searchInit = () => {
    this.searchId++;
    Object.keys(this.searchLoadingStatus).forEach((key) => (this.searchLoadingStatus[key] = false));
  ...
  private updateSearchResult = (searchResults: SearchResult[]) => {
    ...
    this.subscribers.forEach((subscriber) => {
      ...
      subscriber.isSearchingCallBack && subscriber.isSearchingCallBack(this.searchLoadingStatus);
    });
