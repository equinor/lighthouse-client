...
const SumColumnFooterCount = ({ data, fieldKey, value, columnId }: FooterPropsCount<Job>): JSX.Element => {
...
const SumColumnFooterSum = ({ data, fieldKey, value, sumKey }: FooterPropsSum<Job>): JSX.Element => {
            ...
            },
            {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        Aggregated: ({ row }) => {
                            const count = row.subRows.reduce((acc, i) => {
                                acc = i.original.jobStatus === "E10" ? acc + i.original.jobEstimatedHours : acc;
                                return acc
                            }, 0)

                            return count
                        },
                        Footer: (data) => <SumColumnFooterSum data={data} fieldKey={"jobStatus"} value={"E10"} sumKey={"jobEstimatedHours"} />,
                    },
                ],
                ...
                columns: [
                    {
                        ...
                        aggregate: 'count',
                        Footer: (data) => <SumColumnFooterCount data={data} fieldKey={"jobStatus"} value={"E20"} columnId={'E20-WOs'} />,
                    },
                    {
                        id: "E20-Est",
                        Header: 'Est mhrs',
                        ...
                        Aggregated: ({ row }) => {
                            const count = row.subRows.reduce((acc, i) => {
                                acc = i.original.jobStatus === "E20" ? acc + i.original.jobEstimatedHours : acc;
                                return acc
                            }, 0)
                        ...
                        aggregate: 'sum',
                        Footer: (data) => <SumColumnFooterSum data={data} fieldKey={"jobStatus"} value={"E20"} sumKey={"jobEstimatedHours"} />,
                    },
                ],
            },
            {
                ...
                columns: [
                    {
                        ...
                        Footer: (data) => <SumColumnFooterCount data={data} fieldKey={"jobStatus"} value={"E30"} columnId={'E30-WOs'} />,
                    },
                    {
                        id: "E30-Est",
                        Header: 'Est mhrs',
                        ...
                        Aggregated: ({ row }) => {
                            const count = row.subRows.reduce((acc, i) => {
                                acc = i.original.jobStatus === "E30" ? acc + i.original.jobEstimatedHours : acc;
                                return acc
                            }, 0)

                            return count
                        },
                        Footer: (data) => <SumColumnFooterSum data={data} fieldKey={"jobStatus"} value={"E30"} sumKey={"jobEstimatedHours"} />,
                    },
                ],
            },
            {
                ...
                columns: [
                    {
                        ...
                        aggregate: 'count',
                        Footer: (data) => <SumColumnFooterCount data={data} fieldKey={"jobStatus"} value={"E35"} columnId={'E35-WOs'} />,
                    },
                    {
                        id: "E35-Est",
                        Header: 'Est mhrs',
                        ...
                        Aggregated: ({ row }) => {
                            const count = row.subRows.reduce((acc, i) => {
                                acc = i.original.jobStatus === "E35" ? acc + i.original.jobEstimatedHours : acc;
                                return acc
                            }, 0)
                        ...
                        aggregate: 'sum',
                        Footer: (data) => <SumColumnFooterSum data={data} fieldKey={"jobStatus"} value={"E35"} sumKey={"jobEstimatedHours"} />,
                    },
                ],
            },
            {
                ...
                columns: [
                    {
                        ...
                        aggregate: 'count',
                        Footer: (data) => <SumColumnFooterCount data={data} fieldKey={"jobStatus"} value={"E40"} columnId={'E40-WOs'} />,
                    },
                    {
                        id: "E40-Est",
                        Header: 'Est mhrs',
                        ...
                        Aggregated: ({ row }) => {
                            const count = row.subRows.reduce((acc, i) => {
                                acc = i.original.jobStatus === "E40" ? acc + i.original.jobEstimatedHours : acc;
                                return acc
                            }, 0)
                        ...
                        aggregate: 'sum',
                        Footer: (data) => <SumColumnFooterSum data={data} fieldKey={"jobStatus"} value={"E40"} sumKey={"jobEstimatedHours"} />,
                    },
                ],
            },
