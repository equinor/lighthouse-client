 ...
 * @returns
 */
export function useReleaseControlQueryKeyGen(processId: string) {
    ...
    const releaseControlKeys = {
        ...
        canVoidKey: () => [...releaseControlKeys.requestPermissionsKey, 'canVoid'],
        canUnVoidKey: () => [...releaseControlKeys.requestPermissionsKey, 'canUnvoid'],
    };
