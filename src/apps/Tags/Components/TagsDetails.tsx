  ...
  useEffect(() => {
    actions.setTitle(
      <SidesheetHeaderContent
        title={
          item.TagFunctionDescription ? `${item.TagNo}, ${item.TagFunctionDescription}` : item.TagNo
        }
                ...
                >
                  <div>
                    ...
                    <TextItem
                      ...
                      value={
                        item.TagFunctionCode
                          ? `${item.TagFunctionCode || ''}, ${item.TagFunctionDescription || ''}`
                          : ''
                      }
                    />
                    <TextItem
                    ...
                    <TextItem
                      ...
                      value={
                        item.DisciplineCode
                          ? `${item.DisciplineCode || ''}, ${item.DisciplineDescription || ''}`
                          : ''
                      }
                    />
                    <TextItem
