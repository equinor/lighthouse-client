  ...
  customCellView: [
    {
      ...
      cellAttributeFn: (item) => {
        return {
          style: {
            backgroundColor: item.commpkgStatus ? getDotsColor(item.commpkgStatus) : 'transparent',
          },
        };
      },
    },
    {
      ...
      cellAttributeFn: (item) => {
        return {
          style: {
            backgroundColor: item.mcStatus ? getDotsColor(item.mcStatus) : 'transparent',
          },
        };
      },
    },
    ...
    },
    {
      ...
      type: {
        Cell: (cell) => {
          const disciplines = cell.value.content.mcDisciplineCodes.join(',').replace(/,/g, ', ');
          return <>{disciplines}</>;
        },
      },
    },
