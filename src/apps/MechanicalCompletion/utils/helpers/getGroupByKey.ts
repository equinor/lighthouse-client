...
const getFieldKeyBasedOnPlannedForecast = (
  ...
  switch (groupBy) {
    case 'finalPunch':
      return plannedForecast === 'Forecast' ? 'finalPunchForecastDate' : 'finalPunchPlannedDate';
    ...
    case 'punchAccepted':
      return plannedForecast === 'Forecast' ? 'punchAcceptActualDate' : 'punchAcceptActualDate';
