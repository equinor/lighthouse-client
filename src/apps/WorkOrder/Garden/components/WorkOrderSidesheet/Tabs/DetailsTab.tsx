      ...
      <Table>
        <tbody>
          <tr key={'range'}>
            ...
            <td key={'2'}>
              <StringCell
                value={`${formatDateString(workOrder.plannedStartupDate)} - ${formatDateString(
          ...
          <tr key={'projectprogress'}>
            ...
            <td key={'12'}>
              <StringCell
                value={workOrder.projectProgress ? `${workOrder.projectProgress}%` : null}
              />
            </td>
          </tr>
          <tr key={'estimatedmanhours'}>
            ...
            <td key={'14'}>
              <StringCell
                value={workOrder.estimatedHours ? `${workOrder.estimatedHours}h` : null}
              />
            </td>
          </tr>
          <tr key={'remainingmanhours'}>
            ...
            <td key={'16'}>
              <StringCell
                value={workOrder.remainingHours ? `${workOrder.remainingHours}h` : null}
              />
            </td>
          </tr>
          <tr key={'expandedmanhours'}>
            ...
            <td key={'26'}>
              <StringCell value={workOrder.expendedHours ? `${workOrder.expendedHours}h` : null} />
            </td>
          </tr>
          <tr key={'hold'}>
            <td key={'18'}>Hold</td>
