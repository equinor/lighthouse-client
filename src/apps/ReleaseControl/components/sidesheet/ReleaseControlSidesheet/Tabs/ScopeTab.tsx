              ...
              <>
                <SectionWrapper>
                  {tags?.length === 0 && htCables?.length === 0 && (
                    <NoScope>Nothing has been added to the scope of this release control</NoScope>
                  )}
                  <SubSectionText>
                    <SubSectionTitle>
                      {tags?.length !== 0 && 'Tags involved in this release control scope'}
                    </SubSectionTitle>
                    <TagTable tags={tags ?? []} editMode={false} />
                  </SubSectionText>
                  <SubSectionText>
                    <SubSectionTitle>{htCables?.length !== 0 && 'HT cables'}</SubSectionTitle>
