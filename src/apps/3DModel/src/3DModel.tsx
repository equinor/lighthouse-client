...
import { THREE, threeD, ThreeDConfig, ThreeDContextProvider, ThreeDInstance } from "@equinor/ThreeDViewer";
...
export const ModelViewer = (appApi: AppApi): JSX.Element => {
    ...
    useEffect(() => {
        async function setup() {
            ...
            const getToken = () => appApi.authProvider.getAccessToken(["d484c551-acf8-45bc-b1e8-3f4373bd0d42/user_impersonation"]);
            ...
            instance.viewer.setBackgroundColor(new THREE.Color(tokens.colors.ui.background__info.hex))
